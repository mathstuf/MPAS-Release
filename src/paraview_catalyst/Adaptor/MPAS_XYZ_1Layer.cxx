                        ...
                        double* xVertex, double* yVertex, double* zVertex)
{
  ...
  if (vtkCPAdaptorAPI::GetCoProcessorData()->GetIfGridIsNecessary("X_Y_Z_1LAYER-primal")) {
    vtkUnstructuredGrid* pgrid = vtkUnstructuredGrid::New();
    vtkCPAdaptorAPI::GetCoProcessorData()->
                     GetInputDescriptionByName("X_Y_Z_1LAYER-primal")->SetGrid(pgrid);
    pgrid->Initialize();
  ...
  if (vtkCPAdaptorAPI::GetCoProcessorData()->GetIfGridIsNecessary("X_Y_Z_1LAYER-dual")) {
    vtkUnstructuredGrid* dgrid = vtkUnstructuredGrid::New();
    vtkCPAdaptorAPI::GetCoProcessorData()->
                     GetInputDescriptionByName("X_Y_Z_1LAYER-dual")->SetGrid(dgrid);
    dgrid->Initialize();
                 ...
                 vector<bool> const& makeCell)
{
  ...
  vtkUnstructuredGrid* grid = vtkUnstructuredGrid::SafeDownCast(
      vtkCPAdaptorAPI::GetCoProcessorData()->
                       GetInputDescriptionByName (("X_Y_Z_1LAYER" + suffix).c_str())->GetGrid());
